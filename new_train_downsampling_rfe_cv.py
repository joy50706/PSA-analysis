...
for repeats in range(40):
    ...
    ####rf
        ...
        for train_index, test_index in rkf.split(temp_X_train):
            ...
            f=open('new_results_downsampling_data/'+str(repeats)+'/rfe_rf_cv/results_'+str(n_features)+'_'+str(count)+'.txt','w')
    ...
    ####SVM
        ...
        for train_index, test_index in rkf.split(temp_X_train):
            ...
            y_pred_rf=model_rf.predict_proba(new_X_test)
            f=open('new_results_downsampling_data/'+str(repeats)+'/rfe_svm_cv/results_'+str(n_features)+'_'+str(count)+'.txt','w')
            for i in range(len(new_y_test)):
                f.write(str(new_y_test[i])+'\t'+str(y_pred_rf[i][1])+'\n')
            f.close()  
            count+=1
        ...
        for train_index, test_index in rkf.split(temp_X_train):
            ...
            y_pred_rf=model_rf.predict_proba(new_X_test)
            f=open('new_results_downsampling_data/'+str(repeats)+'/rfe_xgb_cv/results_'+str(n_features)+'_'+str(count)+'.txt','w')
            for i in range(len(new_y_test)):
                f.write(str(new_y_test[i])+'\t'+str(y_pred_rf[i][1])+'\n')
            f.close()  
            count+=1
        ...
        for train_index, test_index in rkf.split(temp_X_train):
            ...
            y_pred_rf=model_rf.predict_proba(new_X_test)
            f=open('new_results_downsampling_data/'+str(repeats)+'/rfe_gbr_cv/results_'+str(n_features)+'_'+str(count)+'.txt','w')
            for i in range(len(new_y_test)):
                f.write(str(new_y_test[i])+'\t'+str(y_pred_rf[i][1])+'\n')
            f.close()  
            count+=1
        ...
        for train_index, test_index in rkf.split(temp_X_train):
            ...
            y_pred_rf=model_rf.predict_proba(new_X_test)
            f=open('new_results_downsampling_data/'+str(repeats)+'/rfe_ada_cv/results_'+str(n_features)+'_'+str(count)+'.txt','w')
            for i in range(len(new_y_test)):
                f.write(str(new_y_test[i])+'\t'+str(y_pred_rf[i][1])+'\n')
            f.close()  
            count+=1
        ...
        for train_index, test_index in rkf.split(temp_X_train):
            ...
            y_pred_rf=model_rf.predict_proba(new_X_test)
            f=open('new_results_downsampling_data/'+str(repeats)+'/rfe_lr_cv/results_'+str(n_features)+'_'+str(count)+'.txt','w')
            for i in range(len(new_y_test)):
                f.write(str(new_y_test[i])+'\t'+str(y_pred_rf[i][1])+'\n')
            f.close()  
            count+=1
        ...
        for train_index, test_index in rkf.split(temp_X_train):
            ...
            y_pred_rf=model_rf.predict_proba(new_X_test)
            f=open('new_results_downsampling_data/'+str(repeats)+'/rfe_sgd_cv/results_'+str(n_features)+'_'+str(count)+'.txt','w')
            for i in range(len(new_y_test)):
                f.write(str(new_y_test[i])+'\t'+str(y_pred_rf[i][1])+'\n')
            f.close()  
            count+=1
