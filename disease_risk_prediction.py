# -*- coding: utf-8 -*-
"""
Created on Wed Dec  1 14:30:47 2021
...
lr_pred_prob=[]
true_labels=[]
for train, test in loo.split(new_data):
    X_train=new_data[train]
    X_test=new_data[test]
...
df_save.to_csv('new_results/risk_prediction/all_features_new_data.csv',index=None)