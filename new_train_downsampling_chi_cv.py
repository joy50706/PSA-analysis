...
for repeats in range(40):
    ...
    #     selected_features_name.append(features_name[each_index])
        selector=SelectKBest(chi2, k=n_features).fit(X_train, y_train)
    # selected_index=selector.get_support
        temp_X_train=selector.transform(X_train)
        temp_X_test=selector.transform(X_test)        
    ...
    ####rf
        ...
        for train_index, test_index in rkf.split(temp_X_train):
            ...
            f=open('new_results_downsampling_data/'+str(repeats)+'/chi2_rf_cv/results_'+str(n_features)+'_'+str(count)+'.txt','w')
        ...
        f=open('new_results_downsampling_data/'+str(repeats)+'/chi2_rf_cv/results_'+str(n_features)+'.txt','w')
    ...
    ####SVM
        ...
        for train_index, test_index in rkf.split(temp_X_train):
            ...
            y_pred_rf=model_rf.predict_proba(new_X_test)
            f=open('new_results_downsampling_data/'+str(repeats)+'/chi2_svm_cv/results_'+str(n_features)+'_'+str(count)+'.txt','w')
            for i in range(len(new_y_test)):
                f.write(str(new_y_test[i])+'\t'+str(y_pred_rf[i][1])+'\n')
            f.close()  
            count+=1
        ...
        y_pred_rf=model_rf.predict_proba(temp_X_test)
        f=open('new_results_downsampling_data/'+str(repeats)+'/chi2_svm_cv/results_'+str(n_features)+'.txt','w')
        for i in range(len(y_test)):
            f.write(str(y_test[i])+'\t'+str(y_pred_rf[i][1])+'\n')
        f.close() 
        ####XGB
        ...
        for train_index, test_index in rkf.split(temp_X_train):
            ...
            y_pred_rf=model_rf.predict_proba(new_X_test)
            f=open('new_results_downsampling_data/'+str(repeats)+'/chi2_xgb_cv/results_'+str(n_features)+'_'+str(count)+'.txt','w')
            for i in range(len(new_y_test)):
                f.write(str(new_y_test[i])+'\t'+str(y_pred_rf[i][1])+'\n')
            f.close()  
            count+=1
        ...
        y_pred_rf=model_rf.predict_proba(temp_X_test)
        f=open('new_results_downsampling_data/'+str(repeats)+'/chi2_xgb_cv/results_'+str(n_features)+'.txt','w')
        for i in range(len(y_test)):
            f.write(str(y_test[i])+'\t'+str(y_pred_rf[i][1])+'\n')
        f.close() 
        ###GBR
        ...
        for train_index, test_index in rkf.split(temp_X_train):
            ...
            y_pred_rf=model_rf.predict_proba(new_X_test)
            f=open('new_results_downsampling_data/'+str(repeats)+'/chi2_gbr_cv/results_'+str(n_features)+'_'+str(count)+'.txt','w')
            for i in range(len(new_y_test)):
                f.write(str(new_y_test[i])+'\t'+str(y_pred_rf[i][1])+'\n')
            f.close()  
            count+=1
        ...
        y_pred_rf=model_rf.predict_proba(temp_X_test)
        f=open('new_results_downsampling_data/'+str(repeats)+'/chi2_gbr_cv/results_'+str(n_features)+'.txt','w')
        for i in range(len(y_test)):
            f.write(str(y_test[i])+'\t'+str(y_pred_rf[i][1])+'\n')
        f.close() 
        ...
        for train_index, test_index in rkf.split(temp_X_train):
            ...
            y_pred_rf=model_rf.predict_proba(new_X_test)
            f=open('new_results_downsampling_data/'+str(repeats)+'/chi2_ada_cv/results_'+str(n_features)+'_'+str(count)+'.txt','w')
            for i in range(len(new_y_test)):
                f.write(str(new_y_test[i])+'\t'+str(y_pred_rf[i][1])+'\n')
            f.close()  
            count+=1
        ...
        y_pred_rf=model_rf.predict_proba(temp_X_test)
        f=open('new_results_downsampling_data/'+str(repeats)+'/chi2_ada_cv/results_'+str(n_features)+'.txt','w')
        for i in range(len(y_test)):
            f.write(str(y_test[i])+'\t'+str(y_pred_rf[i][1])+'\n')
        f.close() 
        ...
        for train_index, test_index in rkf.split(temp_X_train):
            ...
            y_pred_rf=model_rf.predict_proba(new_X_test)
            f=open('new_results_downsampling_data/'+str(repeats)+'/chi2_lr_cv/results_'+str(n_features)+'_'+str(count)+'.txt','w')
            for i in range(len(new_y_test)):
                f.write(str(new_y_test[i])+'\t'+str(y_pred_rf[i][1])+'\n')
            f.close()  
            count+=1
        ...
        y_pred_rf=model_rf.predict_proba(temp_X_test)
        f=open('new_results_downsampling_data/'+str(repeats)+'/chi2_lr_cv/results_'+str(n_features)+'.txt','w')
        for i in range(len(y_test)):
            f.write(str(y_test[i])+'\t'+str(y_pred_rf[i][1])+'\n')
        f.close() 
        ...
        for train_index, test_index in rkf.split(temp_X_train):
            ...
            y_pred_rf=model_rf.predict_proba(new_X_test)
            f=open('new_results_downsampling_data/'+str(repeats)+'/chi2_sgd_cv/results_'+str(n_features)+'_'+str(count)+'.txt','w')
            for i in range(len(new_y_test)):
                f.write(str(new_y_test[i])+'\t'+str(y_pred_rf[i][1])+'\n')
            f.close()  
            count+=1
        ...
        y_pred_rf=model_rf.predict_proba(temp_X_test)
        f=open('new_results_downsampling_data/'+str(repeats)+'/chi2_sgd_cv/results_'+str(n_features)+'.txt','w')
        for i in range(len(y_test)):
            f.write(str(y_test[i])+'\t'+str(y_pred_rf[i][1])+'\n')
        f.close()     