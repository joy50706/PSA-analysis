# -*- coding: utf-8 -*-
"""
Created on Sat Feb 12 06:35:12 2022
...
data_df = pd.DataFrame(new_data, columns = new_features_name)

for n_features in range(5,105,5):
    selector=SelectKBest(mutual_info_classif, k=n_features).fit(new_data, labels)
    ...
    df_save.to_csv(f'new_results/risk_prediction/new_data_mi_features_{n_features}.csv',index=None)