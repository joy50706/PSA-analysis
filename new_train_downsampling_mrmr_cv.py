# -*- coding: utf-8 -*-
"""
Created on Tue Mar 15 09:54:45 2022
...
for repeats in range(40):
    ...
    ####rf
        ...
        for train_index, test_index in rkf.split(temp_X_train):
            ...
            f=open('new_results_downsampling_data/'+str(repeats)+'/mrmr_rf_cv/results_'+str(n_features)+'_'+str(count)+'.txt','w')
        ...
        f=open('new_results_downsampling_data/'+str(repeats)+'/mrmr_rf_cv/results_'+str(n_features)+'.txt','w')
    ...
    ####SVM
        ...
        for train_index, test_index in rkf.split(temp_X_train):
            ...
            y_pred_rf=model_rf.predict_proba(new_X_test)
            f=open('new_results_downsampling_data/'+str(repeats)+'/mrmr_svm_cv/results_'+str(n_features)+'_'+str(count)+'.txt','w')
            for i in range(len(new_y_test)):
                f.write(str(new_y_test[i])+'\t'+str(y_pred_rf[i][1])+'\n')
            f.close()  
            count+=1
        ...
        y_pred_rf=model_rf.predict_proba(temp_X_test)
        f=open('new_results_downsampling_data/'+str(repeats)+'/mrmr_svm_cv/results_'+str(n_features)+'.txt','w')
        for i in range(len(y_test)):
            f.write(str(y_test[i])+'\t'+str(y_pred_rf[i][1])+'\n')
        f.close() 
        ####XGB
        ...
        for train_index, test_index in rkf.split(temp_X_train):
            ...
            y_pred_rf=model_rf.predict_proba(new_X_test)
            f=open('new_results_downsampling_data/'+str(repeats)+'/mrmr_xgb_cv/results_'+str(n_features)+'_'+str(count)+'.txt','w')
            for i in range(len(new_y_test)):
                f.write(str(new_y_test[i])+'\t'+str(y_pred_rf[i][1])+'\n')
            f.close()  
            count+=1
        ...
        y_pred_rf=model_rf.predict_proba(temp_X_test)
        f=open('new_results_downsampling_data/'+str(repeats)+'/mrmr_xgb_cv/results_'+str(n_features)+'.txt','w')
        for i in range(len(y_test)):
            f.write(str(y_test[i])+'\t'+str(y_pred_rf[i][1])+'\n')
        f.close() 
        ###GBR
        ...
        for train_index, test_index in rkf.split(temp_X_train):
            ...
            y_pred_rf=model_rf.predict_proba(new_X_test)
            f=open('new_results_downsampling_data/'+str(repeats)+'/mrmr_gbr_cv/results_'+str(n_features)+'_'+str(count)+'.txt','w')
            for i in range(len(new_y_test)):
                f.write(str(new_y_test[i])+'\t'+str(y_pred_rf[i][1])+'\n')
            f.close()  
            count+=1
        ...
        y_pred_rf=model_rf.predict_proba(temp_X_test)
        f=open('new_results_downsampling_data/'+str(repeats)+'/mrmr_gbr_cv/results_'+str(n_features)+'.txt','w')
        for i in range(len(y_test)):
            f.write(str(y_test[i])+'\t'+str(y_pred_rf[i][1])+'\n')
        f.close() 
        ...
        for train_index, test_index in rkf.split(temp_X_train):
            ...
            y_pred_rf=model_rf.predict_proba(new_X_test)
            f=open('new_results_downsampling_data/'+str(repeats)+'/mrmr_ada_cv/results_'+str(n_features)+'_'+str(count)+'.txt','w')
            for i in range(len(new_y_test)):
                f.write(str(new_y_test[i])+'\t'+str(y_pred_rf[i][1])+'\n')
            f.close()  
            count+=1
        ...
        y_pred_rf=model_rf.predict_proba(temp_X_test)
        f=open('new_results_downsampling_data/'+str(repeats)+'/mrmr_ada_cv/results_'+str(n_features)+'.txt','w')
        for i in range(len(y_test)):
            f.write(str(y_test[i])+'\t'+str(y_pred_rf[i][1])+'\n')
        f.close() 
        ...
        for train_index, test_index in rkf.split(temp_X_train):
            ...
            y_pred_rf=model_rf.predict_proba(new_X_test)
            f=open('new_results_downsampling_data/'+str(repeats)+'/mrmr_lr_cv/results_'+str(n_features)+'_'+str(count)+'.txt','w')
            for i in range(len(new_y_test)):
                f.write(str(new_y_test[i])+'\t'+str(y_pred_rf[i][1])+'\n')
            f.close()  
            count+=1
        ...
        y_pred_rf=model_rf.predict_proba(temp_X_test)
        f=open('new_results_downsampling_data/'+str(repeats)+'/mrmr_lr_cv/results_'+str(n_features)+'.txt','w')
        for i in range(len(y_test)):
            f.write(str(y_test[i])+'\t'+str(y_pred_rf[i][1])+'\n')
        f.close() 
        ...
        for train_index, test_index in rkf.split(temp_X_train):
            ...
            y_pred_rf=model_rf.predict_proba(new_X_test)
            f=open('new_results_downsampling_data/'+str(repeats)+'/mrmr_sgd_cv/results_'+str(n_features)+'_'+str(count)+'.txt','w')
            for i in range(len(new_y_test)):
                f.write(str(new_y_test[i])+'\t'+str(y_pred_rf[i][1])+'\n')
            f.close()  
            count+=1
        ...
        y_pred_rf=model_rf.predict_proba(temp_X_test)
        f=open('new_results_downsampling_data/'+str(repeats)+'/mrmr_sgd_cv/results_'+str(n_features)+'.txt','w')
        for i in range(len(y_test)):
            f.write(str(y_test[i])+'\t'+str(y_pred_rf[i][1])+'\n')
        f.close()     